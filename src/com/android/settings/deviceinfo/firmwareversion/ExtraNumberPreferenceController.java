...
public class ExtraNumberPreferenceController extends BasePreferenceController {

    private static final String TAG = "extraNumberDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_EXTRA_VERSION_NUMBER_PROP = "ro.extra.version.number";

    private static final String PLATLOGO_PACKAGE_NAME = "com.kusuma.egg";
    ...
    public ExtraNumberPreferenceController(Context context, String key) {
        super(context, key);
    ...
    public CharSequence getSummary() {
        return SystemProperties.get(KEY_EXTRA_VERSION_NUMBER_PROP,
